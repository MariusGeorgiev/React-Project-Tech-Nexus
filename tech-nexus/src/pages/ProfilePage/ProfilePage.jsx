...
import { getFirestore, collection, query, where, doc, orderBy, getDoc, updateDoc, getDocs } from 'firebase/firestore';
  ...
  const fetchUserData = async (userId) => {
    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        setRegisteredOn(userData.registeredOn?.toDate().toLocaleString() || 'N/A');
